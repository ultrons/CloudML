...
export train_data="gs://${BUCKET}/${DATASET}/tfrecords_no_ovr_sampleing/train*"
export val_data="gs://${BUCKET}/${DATASET}/tfrecords_no_ovr_sampleing/valid*"
